...
//    PGSettingContentTypeDataRecover,        //数据恢复
    ...
    return @[
             ...
             @{@"sectionTitle":NSLocalizedString(@"Focus Settings", nil),@"data":@[
                       ...
                       @{@"title":NSLocalizedString(@"Enter next Pigo automatically", nil),@"eventType":@(PGSettingEventTypeSwicher),@"contentType":@(PGSettingContentTypeAutomaticNext),@"detail":@(PGConfigMgr.AutomaticNext),@"paraName":PGConfigParaAutomaticNext},
